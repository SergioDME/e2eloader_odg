...
public class UrlDependency {
    public static void check_url_dependencies(List<ResponseUnstructured> response, int req_index, DependencyGraph dependencyGraph, MyNode to){
    ...
    private static boolean check_subpath(String path, Object response, DependencyGraph dependencyGraph, MyNode to , MyNode from, String possible_name){
        boolean res = false;
    ...
    private static boolean check_subpath_atomic_evaluation(Object o, String path, MyNode from, DependencyGraph dependencyGraph, Boolean res, MyNode to, StructuredObject father, String possibile_name){
